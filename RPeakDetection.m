...
% clc
% clear all
% p = dlmread('ekg_raw_16272');
% RawECG = p(430000:432000,2);

function [Rpeak_index Rpeak_values signal] = RPeakDetection(RawECG)
signal = [];
for i = 13:45
    index = i - 12;
    if(index < 3)
...
thresholdUp = 0.00002*DynamicRangeUp;
thresholdR = 0.6*DynamicRangeUp;
